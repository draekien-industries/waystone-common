...
/// <summary>An exception that is thrown when the requested resource does not exist.</summary>
[Serializable]
public class NotFoundException : ApplicationException
{
    /// <summary>Initializes a new instance of the <see cref="NotFoundException" /> with the default error message.</summary>
    ...
    public NotFoundException(Type entityType, string key) : base(
        $"The requested resource '{entityType.Name}' ({key}) could not be found.")
    { }

    /// <summary>Initializes a new instance of the <see cref="NotFoundException" /> using the specified error message.</summary>
