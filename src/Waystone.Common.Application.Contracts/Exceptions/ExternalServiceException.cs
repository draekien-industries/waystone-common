...
/// <summary>An exception that is thrown with an external service does not return an expected response.</summary>
[Serializable]
public class ExternalServiceException : ApplicationException
{
    /// <summary>Initializes a new instance of the <see cref="ExternalServiceException" /> with the default message.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ExternalServiceException" /> class with serialized data.</summary>
