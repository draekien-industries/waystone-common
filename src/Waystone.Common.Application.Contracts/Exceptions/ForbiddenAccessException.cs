...
/// <summary>
/// An exception that is thrown when an action is forbidden by the application.
/// </summary>
[Serializable]
public class ForbiddenAccessException : ApplicationException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ForbiddenAccessException"/> class with a specified message and inner exception.
    /// </summary>
    /// <param name="message">The exception message.</param>
